  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-black text-white selection:bg-primary/30">
        ...
        <section id="home" className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-40 pb-20 z-10">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black tracking-tight leading-[0.95] md:leading-[0.9] animate-reveal">
              BUILT TO LAST, <br />
              <span className="text-primary text-3xl sm:text-4xl md:text-6xl lg:text-7xl block mt-4">NOT JUST TO LAUNCH</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 animate-fade-in delay-200">
              <Link
                href="/contact"
                className="group relative px-12 py-5 bg-blue-500 text-black font-black uppercase tracking-[0.2em] text-[11px] rounded-full transition-all duration-500 hover:shadow-[0_0_40px_rgba(59,130,246,0.3)] hover:scale-105 active:scale-95"
              >
                Book a Call
              </Link>
              <Link
                ...
                className="group px-12 py-5 bg-transparent border border-white/10 text-white font-black uppercase tracking-[0.2em] text-[11px] rounded-full transition-all duration-500 hover:bg-white/5 hover:border-white/30 hover:scale-105 active:scale-95"
              >
                View Work
              </Link>
            </div>
            ...
            <div className="flex items-center justify-center gap-12 md:gap-24 pt-20 animate-fade-in delay-300">
              <div className="text-center group cursor-default">
                <p className="text-4xl font-black text-white tracking-tighter mb-2 group-hover:text-primary transition-colors duration-500">99.9%</p>
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/30">Stability</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10"></div>
              <div className="text-center group cursor-default">
                <p className="text-4xl font-black text-primary tracking-tighter mb-2 group-hover:scale-110 transition-all duration-500">8+</p>
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/30">Live Systems</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10"></div>
              <div className="text-center group cursor-default">
                <p className="text-4xl font-black text-white tracking-tighter mb-2 group-hover:text-primary transition-colors duration-500">310%</p>
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/30">Avg. ROI</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="info" className="py-24 bg-white/[0.02] border-y border-white/5 relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center mb-16 text-center animate-fade-in">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-[1px] bg-primary"></div>
                <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Strategic Focus</p>
                <div className="w-12 h-[1px] bg-primary"></div>
              </div>
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-8">OUR NICHE.</h2>
              <p className="text-xl text-white/40 max-w-3xl mx-auto font-medium leading-relaxed">
                We specialize in bridging the gap between <span className="text-white">complex physical operations</span> and <span className="text-primary font-bold">mature AI ecosystems</span>. Our niche is high-stakes automation where reliability, security, and 10x ROI are non-negotiable.
              </p>
            </div>
            ...
            <div className="mt-20">
              <div className="flex flex-col items-center mb-10 text-center">
                <div className="w-full overflow-hidden relative group">
                  <div className="flex animate-ticker whitespace-nowrap gap-12 text-sm font-black uppercase tracking-[0.2em] text-white/25 hover:[animation-play-state:paused] transition-colors duration-500">
                    {[1, 2, 3, 4].map((i) => (
