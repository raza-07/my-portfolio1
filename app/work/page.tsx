      ...
      <main className="bg-black text-white">
        ...
        <section className="relative min-h-screen flex flex-col justify-center px-6 pt-32 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-full animate-fade-in">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50">Production Case Studies</span>
              </div>
          ...
          >
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-white/20 group-hover:text-primary transition-colors">Navigate Insights</span>
          </div>
        </section>
        ...
        <section className="py-40 px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-10">
            ...
            <p className="text-xl text-white/30 font-medium">Ready to build the next system that defines your industry?</p>
            <div className="pt-6">
              <a
                href="/contact"
